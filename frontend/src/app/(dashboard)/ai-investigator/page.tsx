  ...
  return (
    <div className="h-full p-4 flex gap-4 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-dark p-4 space-y-4">
                  ...
                  <div className="pt-2 border-t border-white/10 flex flex-wrap gap-2">
                    {msg.response.actions.map((act, aIdx) => (
                      <button
                        ...
                        className="px-2.5 py-1 rounded bg-crimenet-cyan/15 hover:bg-crimenet-cyan/30 text-crimenet-cyan border border-crimenet-cyan/40 font-mono text-[10px] font-bold transition-colors flex items-center gap-1.5"
                      >
                        <span>{act.label}</span>
          ...
          {loading && (
            <div className="flex gap-3 max-w-xl">
              ...
              <div className="glass-card p-3 rounded-xl rounded-tl-none flex items-center gap-2 text-xs text-crimenet-cyan font-mono">
        ...
        <div className="p-4 border-t border-white/10 bg-black/50 space-y-2">
          ...
          >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-crimenet-muted hover:text-white border border-white/10 transition-colors"
            ...
            <button
              ...
              className={`p-2.5 rounded-xl border transition-all ${
                isRecording 
                  ? 'bg-crimenet-crimson text-white border-crimenet-crimson animate-pulse shadow-lg shadow-crimson-500/50' 
                  : 'bg-white/5 hover:bg-white/10 text-crimenet-cyan border-white/10'
              }`}
            ...
            <input
              ...
              className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white placeholder-crimenet-muted focus:outline-none focus:border-crimenet-cyan font-sans"
            />
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-crimenet-cyan hover:bg-cyan-400 text-black font-bold text-xs flex items-center gap-1.5 transition-colors disabled:opacity-30 shadow-lg shadow-cyan-500/20"
            >
      ...
      <div className="w-80 flex flex-col gap-4">
        ...
        {/* Suggested Queries */}
        <GlassPanel title="INVESTIGATIVE PROMPTS (ENGLISH / HINDI)">
          <div className="space-y-2">
            {SUGGESTED_QUERIES.map((q, idx) => (
              <button
                key={idx}
                onClick={() => handleSend(q)}
                className="w-full text-left p-2.5 rounded-xl bg-white/5 hover:bg-crimenet-cyan/15 border border-white/5 hover:border-crimenet-cyan/30 text-xs text-white/90 transition-all flex items-start gap-2 group"
              >
